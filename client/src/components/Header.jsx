          ...
          <div className="flex items-center justify-between w-11/12">
            <div className="flex items-center space-x-2 sm:space-x-3">
              ...
              <div className='flex flex-row items-center sm:space-x-3'>
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-[var(--primary-color)] to-[var(--accent-color)] rounded-xl sm:rounded-2xl flex items-center justify-center shadow-lg max-sm:sr-only">
